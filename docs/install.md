...
together. The `0.4.4` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.4.4`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.4.4/kapro-operator-0.4.4.tgz --untar
