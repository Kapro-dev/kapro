...
together. The `0.4.16` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.4.16`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.4.16/kapro-operator-0.4.16.tgz --untar
