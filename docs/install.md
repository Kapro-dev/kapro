...
together. The `0.3.6` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.3.6`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.3.6/kapro-operator-0.3.6.tgz --untar
