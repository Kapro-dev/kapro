...
together. The `0.4.15` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.4.15`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.4.15/kapro-operator-0.4.15.tgz --untar
