...
together. The `0.5.1` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.5.1`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.5.1/kapro-operator-0.5.1.tgz --untar
