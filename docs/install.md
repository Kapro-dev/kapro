...
together. The `0.4.8` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.4.8`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.4.8/kapro-operator-0.4.8.tgz --untar
