...
together. The `0.5.3` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.5.3`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.5.3/kapro-operator-0.5.3.tgz --untar
