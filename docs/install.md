...
together. The `0.4.20` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.4.20`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.4.20/kapro-operator-0.4.20.tgz --untar
