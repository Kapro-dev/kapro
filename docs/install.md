...
together. The `0.5.5` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.5.5`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.5.5/kapro-operator-0.5.5.tgz --untar
