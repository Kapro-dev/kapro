...
together. The `0.4.9` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.4.9`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.4.9/kapro-operator-0.4.9.tgz --untar
