...
together. The `0.6.2` chart defaults to
`ghcr.io/kapro-dev/kapro-operator:v0.6.2`.
...
```bash
helm pull https://github.com/Kapro-dev/kapro/releases/download/v0.6.2/kapro-operator-0.6.2.tgz --untar
