...
Kapro's direction is a backend-neutral promotion control plane. Kapro decides
...
| Can a platform team add its own backend? | Yes, through the Go actuator SDK or gRPC plugin contract. |
