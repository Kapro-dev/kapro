...
| Release manager | Release and trigger policy for one team or app | Create/update `Release`, `ReleaseTrigger`, `Pipeline`, `KaproApp` with team labels |
...
|---|---|---|
| `kapro.io/team` | `Release`, `ReleaseTrigger`, `Pipeline`, `KaproApp`, `Approval` | Owning team or service group |
...
rules:
  - apiGroups: ["kapro.io"]
    resources: ["releases", "releasetriggers", "pipelines", "kaproapps"]
