...
./examples/cloud/gcp/register-spoke.sh \
  ...
  --image         europe-west4-docker.pkg.dev/my-project/kapro/cluster-controller:v0.1.0 \
...
./examples/cloud/gcp/register-spoke.sh \
  ...
  --image         europe-west4-docker.pkg.dev/my-hub-project/kapro/cluster-controller:v0.1.0 \
