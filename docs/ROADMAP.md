...
1. Replace hand-written Go interfaces with generated ones (or thin wrappers)
2. Implement `PluginGateway`: gRPC boundary for endpoints registered via `PluginRegistration`
3. Ship ArgoCD actuator as first external plugin to validate the model
