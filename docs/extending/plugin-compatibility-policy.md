...
```text
Kapro-compatible: KAI v1alpha1, tested with kapro-conformance v0.6.2
```

For a Go provider:

```text
Kapro-compatible: KSP v1alpha1, tested with kapro.io/kapro/conformance/provider v0.6.2
```
