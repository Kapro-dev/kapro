...
func diagTestScheme(t *testing.T) *runtime.Scheme {
	...
	if err := kaproruntimev1alpha1.AddToScheme(s); err != nil {
		t.Fatalf("kapro runtime scheme: %v", err)
	}
	return s
}
...
func TestRunDiag_HappyPathRendersExpectedSections(t *testing.T) {
	...
	event := &corev1.Event{
		...
		InvolvedObject: corev1.ObjectReference{APIVersion: "kapro.io/v1alpha1", Kind: "Promotion", Name: "checkout-v1.2.3"},
...
func TestRunDiag_JSONOutputIsStable(t *testing.T) {
	promo := &kaprov1alpha1.Promotion{
		...
		Spec:       kaprov1alpha1.PromotionSpec{FleetRef: "k1", Version: "v1", Suspended: true},
...
func TestComputeBlockedOn_FailedTarget(t *testing.T) {
	...
	targets := []kaproruntimev1alpha1.Target{{
		Spec: kaprov1alpha1.TargetSpec{Target: "de-prod", Stage: "canary"},
		Status: kaprov1alpha1.TargetStatus{
			TargetExecutionState: kaprov1alpha1.TargetExecutionState{Phase: kaprov1alpha1.TargetPhaseFailed, Message: "gate timeout"},
		},
	}}
...
func TestFilterPromotionEvents_OnlyMatchingObjects(t *testing.T) {
	promo := &kaprov1alpha1.Promotion{ObjectMeta: metav1.ObjectMeta{Name: "p"}}
	runs := []kaproruntimev1alpha1.PromotionRun{{ObjectMeta: metav1.ObjectMeta{Name: "r1"}}}
	targets := []kaproruntimev1alpha1.Target{{ObjectMeta: metav1.ObjectMeta{Name: "t1"}}}
	all := []corev1.Event{
		{InvolvedObject: corev1.ObjectReference{APIVersion: "kapro.io/v1alpha1", Kind: "Promotion", Name: "p"}, Reason: "A"},
		{InvolvedObject: corev1.ObjectReference{APIVersion: "runtime.kapro.io/v1alpha1", Kind: "PromotionRun", Name: "r1"}, Reason: "B"},
		{InvolvedObject: corev1.ObjectReference{APIVersion: "runtime.kapro.io/v1alpha1", Kind: "Target", Name: "t1"}, Reason: "C"},
		{InvolvedObject: corev1.ObjectReference{APIVersion: "kapro.io/v1alpha1", Kind: "Promotion", Name: "other"}, Reason: "C"},
