...
func TestStatusTick_PatchesCapabilities(t *testing.T) {
	...
	sr := &statusReporter{
		...
		ControllerVersion: "v0.1.0-alpha.1",
	}
	...
	if got.Status.ControllerVersion != "v0.1.0-alpha.1" {
		t.Errorf("ControllerVersion = %q, want v0.1.0-alpha.1", got.Status.ControllerVersion)
	}
}
