...
Fixture resources used by the Kind demo.

```text
Flux namespace + HelmRelease fixtures + ResourceSet fixture
```

Apply after demo CRDs.
...
```bash
kubectl delete -f examples/10-kind-demo/fixtures --ignore-not-found
```
