...
func TestFleetClusterReadyConditionChangedPredicate(t *testing.T) {
	...
	base := &kaprov1alpha1.FleetCluster{
	...
	noCond := &kaprov1alpha1.FleetCluster{ObjectMeta: metav1.ObjectMeta{Name: "c"}}
	...
	// Both nil → no trigger.
	emptyOld := &kaprov1alpha1.FleetCluster{ObjectMeta: metav1.ObjectMeta{Name: "c"}}
