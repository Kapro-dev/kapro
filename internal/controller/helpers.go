...
func promotionTargetSpecEqual(current, desired *kaproruntimev1alpha1.Target) bool {
...
func fleetClusterStatusEqualForRollouts(a, b kaprov1alpha1.ClusterStatus) bool {
