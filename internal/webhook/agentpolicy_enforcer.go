...
type PolicyDecision struct {
	Allowed            bool
	EffectiveMode      kaprov1alpha1.PolicyMode
...
func (s *Server) resolveAgentPolicy(ctx context.Context, agentName string) (*kaprov1alpha1.Policy, error) {
	var list kaprov1alpha1.PolicyList
...
func enforceAgentPolicy(
	...
	if mode == kaprov1alpha1.PolicyModeDisabled {
...
func (s *Server) reserveAgentPolicySlot(ctx context.Context, policy *kaprov1alpha1.Policy) (bool, string, error) {
	const maxRetries = 5
...
func (s *Server) releaseAgentPolicySlot(ctx context.Context, policy *kaprov1alpha1.Policy) error {
	const maxRetries = 5
	key := client.ObjectKey{Namespace: policy.Namespace, Name: policy.Name}
