...
func (a *PullActuator) ApplyDelta(ctx context.Context, req actuator.DeltaApplyRequest) (int, error) {
	...
	var latest kaprov1alpha1.Cluster
...
func (a *PullActuator) IsConverged(ctx context.Context, mc *kaprov1alpha1.Cluster, appKey, version string) (bool, error) {
	if appKey == "" {
		appKey = "default"
	}
...
func (a *PullActuator) IsAllConverged(ctx context.Context, mc *kaprov1alpha1.Cluster, desiredVersions map[string]string) (bool, error) {
	_ = ctx
	if mc == nil {
...
func (a *PullActuator) Rollback(ctx context.Context, mc *kaprov1alpha1.Cluster, previousVersion, appKey string) error {
