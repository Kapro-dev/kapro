...
func applicationSelector(mc *kaprov1alpha1.MemberCluster, appKey string) string {
	if appKey != "" && appKey != "default" {
...
func argoVersionField(mc *kaprov1alpha1.MemberCluster, appKey string) string {
	if appKey != "" && appKey != "default" {
...
func authorizeApplicationWrite(mc *kaprov1alpha1.MemberCluster, app *unstructured.Unstructured, appKey string) error {
...
func (a *Actuator) BackendObjects(ctx context.Context, mc *kaprov1alpha1.MemberCluster, desiredVersions map[string]string) ([]kaprov1alpha1.BackendObjectStatus, error) {
