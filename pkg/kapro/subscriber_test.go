...
func TestSubscriberRejectsInvalidRequests(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			method: http.MethodPost,
			path:   "/",
			body:   `{"specversion":"1.0","source":"/apis/kapro.io/v1alpha1/promotions/checkout","type":"kapro.io/promotion.created","time":"2026-05-22T00:00:00Z","datacontenttype":"application/json","data":{"promotion":"checkout"}}`,
			status: http.StatusBadRequest,
		},
		{
			name:   "invalid time",
			method: http.MethodPost,
			path:   "/",
			body:   `{"specversion":"1.0","id":"1","source":"/apis/kapro.io/v1alpha1/promotions/checkout","type":"kapro.io/promotion.created","time":"nope","datacontenttype":"application/json","data":{"promotion":"checkout"}}`,
			status: http.StatusBadRequest,
		},
		{
			...
			method: http.MethodPost,
			path:   "/",
			body:   `{"specversion":"1.0","id":"1","source":"/apis/kapro.io/v1alpha1/promotions/checkout","type":"kapro.io/promotion.created","time":"2026-05-22T00:00:00Z","datacontenttype":"text/plain","data":{"promotion":"checkout"}}`,
			status: http.StatusBadRequest,
		},
	}
