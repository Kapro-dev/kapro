...
// rather than duplicating the sync.RWMutex + map pattern.
//
// # Analogy
//
...
//
// T is the extension interface type (e.g. actuator.Actuator, provider.Connector).
...
// originated from (e.g. "actuator", "provider").
