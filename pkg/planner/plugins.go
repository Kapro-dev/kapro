...
func (ReadinessFilter) Filter(_ context.Context, _ *CycleState, _ Request, target kaprov1alpha1.Cluster) *Status {
...
func (ActivePromotionRunFilter) Filter(_ context.Context, _ *CycleState, req Request, target kaprov1alpha1.Cluster) *Status {
...
func (DeterministicOrder) Score(context.Context, *CycleState, Request, kaprov1alpha1.Cluster) (int64, *Status) {
	return 0, nil
}
