...
#
# Usage:
#   VERSION=v0.6.2 scripts/cut-release.sh
#   VERSION=v0.6.2 KAPRO_RELEASE_SKIP_TAG=true scripts/cut-release.sh   # re-watch existing tag
#
# Required env:
...
[ -n "${VERSION}" ] || abort "VERSION not set; usage: VERSION=v0.6.2 scripts/cut-release.sh"
