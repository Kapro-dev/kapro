...
type SourceSpec struct {
	// BackendRef is the Backend this source is normally discovered from
...
type Unit struct {
	...
	// VersionField is the backend-native field Fleet changes for this unit,
	// for example spec.source.targetRevision for Argo CD Applications.
	// +optional
	VersionField string `json:"versionField,omitempty"`
	// SourcePath is the repo-relative file path Fleet updates for Git-native
