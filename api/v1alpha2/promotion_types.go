...
// The PromotionController creates PromotionRun objects as execution attempts;
// users do not normally write PromotionRun directly.
package v1alpha2
...
// Fleet. The controller materializes intent into one or more PromotionRun
// attempts; PromotionRun and Target are observe-only runtime objects.
