...
var kaproResources = []resourceContract{
	...
	{Kind: "DecisionTrace", Singular: "decisiontrace", Plural: "decisiontraces"},
	{Kind: "Fleet", Singular: "fleet", Plural: "fleets"},
	{Kind: "FleetDriftReport", Singular: "fleetdriftreport", Plural: "fleetdriftreports"},
...
func TestCRDShortNamesAndCategoriesUseExpectedAliases(t *testing.T) {
	...
	expectedShortNames := map[string][]string{
		...
		"kapro.io_fleetdriftreports.yaml": {"fdr"},
...
func TestCRDPropertiesMatchGoJSONTags(t *testing.T) {
	...
	fixtures := map[string]fixture{
		...
		"DecisionTrace":    {"decisiontrace_types.go", "DecisionTraceSpec", "DecisionTraceStatus"},
		"Fleet":            {"fleet_types.go", "FleetSpec", "FleetStatus"},
		"FleetDriftReport": {"fleetdriftreport_types.go", "FleetDriftReportSpec", "FleetDriftReportStatus"},
