...
var kaproResources = []resourceContract{
	...
	{Kind: "ClusterClassifier", Singular: "clusterclassifier", Plural: "clusterclassifiers"},
...
func TestCRDShortNamesAndCategoriesUseExpectedAliases(t *testing.T) {
	...
	expectedShortNames := map[string][]string{
		...
		"kapro.io_clusterclassifiers.yaml": {"cclf"},
...
func TestCRDPropertiesMatchGoJSONTags(t *testing.T) {
	...
	fixtures := map[string]fixture{
		...
		"ClusterClassifier": {
			"clusterclassifier_types.go",
			"ClusterClassifierSpec",
			"ClusterClassifierStatus",
		},
